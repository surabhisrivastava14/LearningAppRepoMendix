...
import xmltrial.proxies.Customer_Address_JA;
import xmltrial.proxies.XmlDocument;
import com.mendix.systemwideinterfaces.core.IMendixObject;

public class SingleEntity_JA extends CustomJavaAction<java.lang.Void>
{
	private IMendixObject __Parameter;
	private xmltrial.proxies.XmlDocument Parameter;

	public SingleEntity_JA(IContext context, IMendixObject Parameter)
	{
		super(context);
		...
		try {
			...
			for (int itr = 0; itr < customerNodesList.getLength(); itr++) {
				...
				if (node.getNodeType() == Node.ELEMENT_NODE) {
					...
					Customer_Address_JA customer = new Customer_Address_JA(getContext());
